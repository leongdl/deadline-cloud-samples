...
| [Deadline Cloud job bundle](job/) | Submitting the same sweep to a farm, pulling the image from ECR and returning frames, MP4 and GIF through job attachments | You want to run the sweep on a fleet rather than locally |
